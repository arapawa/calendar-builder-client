...
class ConfirmFeaturedModal extends Component {
  render() {
    return (
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="featured-modal-title">Make Featured?</h5>
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary">Make Featured</button>
            </div>
          </div>
        </div>
      </div>
